...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 1000    //CAMBIAR AQUI // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE 1000 //CAMBIAR AQUI // (mm/s) Load filament feedrate. This can be pretty fast.
