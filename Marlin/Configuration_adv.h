...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_ZETA_X 0.80f         // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y 38         // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y 0.40f         // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #define SHAPING_MIN_FREQ 20       // (Hz) By default the minimum of the shaping frequencies. Override to affect SRAM usage.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 34      // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE 34    // (mm/s) Load filament feedrate. This can be pretty fast.
